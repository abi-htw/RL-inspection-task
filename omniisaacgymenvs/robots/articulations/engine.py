...
class Engine(Robot):
    def __init__(
        ...
        if self._usd_path is None:
            ...
            self._usd_path = "/inst_assets/bmw_engine/Startor_Version_3/Engine_inst/engine_3.usd"
        ...
        self._position = torch.tensor([0.4, 0.0, 0.75]) if translation is None else translation
